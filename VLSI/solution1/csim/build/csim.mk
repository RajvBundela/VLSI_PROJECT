...
HLS_SOURCES = ../../../../test.cpp ../../../../hand_chrc_nn.cpp
...
$(ObjDir)/hand_chrc_nn.o: ../../../../hand_chrc_nn.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hand_chrc_nn.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hand_chrc_nn.d
