# ==============================================================
# File generated on Sun Nov 13 23:42:54 +0530 2022
...
if {[file isfile hand_chrc_nn.autotvin.dat]} {
	file delete -force hand_chrc_nn.autotvin.dat
}

if {[file isfile hand_chrc_nn.autotvout.dat]} {
	file delete -force hand_chrc_nn.autotvout.dat
}
