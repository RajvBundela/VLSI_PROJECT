# ==============================================================
# File generated on Sun Nov 13 23:42:16 +0530 2022
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hand_chrc_nn.autotvin.dat"
	set constFileTvOut       "hand_chrc_nn.autotvout.dat"
	set constFileHdlTvIn     "hand_chrc_nn.autohdltvin.dat"
	set constFileHdlTvOut    "hand_chrc_nn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
