...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.hand_chrc_nn.autotvout_ap_return.dat"
...
extern char hand_chrc_nn (
float X[784],
int y);

char AESL_WRAP_hand_chrc_nn (
float X[784],
int y)
{
...
// [call_c_dut] ---------->
		...
		char AESL_return = hand_chrc_nn(X, y);
