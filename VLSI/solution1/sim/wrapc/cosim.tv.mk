# ==============================================================
# File generated on Sun Nov 13 23:42:05 +0530 2022
...
$(ObjDir)/hand_chrc_nn.cpp_pre.cpp.tb.o : hand_chrc_nn.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling hand_chrc_nn.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
