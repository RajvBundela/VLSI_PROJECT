...
// ==============================================================
#ifndef __hand_chrc_nn_ddivjbC__HH__
#define __hand_chrc_nn_ddivjbC__HH__
#include "ACMP_ddiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_chrc_nn_ddivjbC) {
    ...
    SC_CTOR(hand_chrc_nn_ddivjbC):  ACMP_ddiv_U ("ACMP_ddiv_U") {
        ACMP_ddiv_U.clk(clk);
