...
// ==============================================================
#ifndef __hand_chrc_nn_dexpkbM__HH__
#define __hand_chrc_nn_dexpkbM__HH__
#include "ACMP_dexp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_chrc_nn_dexpkbM) {
    ...
    SC_CTOR(hand_chrc_nn_dexpkbM):  ACMP_dexp_U ("ACMP_dexp_U") {
        ACMP_dexp_U.clk(clk);
