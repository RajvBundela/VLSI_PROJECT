...
// ==============================================================
#ifndef __hand_chrc_nn_fadddEe__HH__
#define __hand_chrc_nn_fadddEe__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_chrc_nn_fadddEe) {
    ...
    SC_CTOR(hand_chrc_nn_fadddEe):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
