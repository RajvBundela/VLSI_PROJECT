...
// ==============================================================
#ifndef __hand_chrc_nn_fcmphbi__HH__
#define __hand_chrc_nn_fcmphbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_chrc_nn_fcmphbi) {
    ...
    SC_CTOR(hand_chrc_nn_fcmphbi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
