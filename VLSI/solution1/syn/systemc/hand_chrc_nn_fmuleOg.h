...
// ==============================================================
#ifndef __hand_chrc_nn_fmuleOg__HH__
#define __hand_chrc_nn_fmuleOg__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_chrc_nn_fmuleOg) {
    ...
    SC_CTOR(hand_chrc_nn_fmuleOg):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
